...
JNIEXPORT jint Java_org_apache_hadoop_util_ADGSetSocketTOS_setSocketTOS(JNIEnv *env, jclass obj, jobject socket, jint flow_type)
{
    ...
    int tos_local;
    switch (flow_type) {
        case 1: tos_local = 0x21; //000001
                break;
        case 2: tos_local = 0x22; //000010
                break;
        case 3: tos_local = 0x23; //000011
                break;
        case 4: tos_local = 0x24; //000100
                break;
        case 5: tos_local = 0x25; //000101
                break;
        case 6: tos_local = 0x26; //000110
                break;
        case 7: tos_local = 0x27; //000111
                break;
        case 8: tos_local = 0x28; //001000
                printf("datanode pipeline flow!");
                break;
        case 9: tos_local = 0x29; //001001
                break;
        case 10: tos_local = 0x2a; //001010
                break;
        case 11: tos_local = 0x2b; //001011
                break;
        case 12: tos_local = 0x2c; //001100
                break;
        default:
