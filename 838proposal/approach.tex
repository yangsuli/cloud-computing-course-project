...
%We will record GFS performance, such as throuput, respond time,request rate too. 
%(Anyting else? Ask AA or Remzi)
...
%(Ask AA or Remzi: what kind of storage performance metric should we use?)
